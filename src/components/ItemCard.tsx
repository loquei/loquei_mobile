...
export function ItemCard({ type, title, description, price, date, hasRemoveButton, hasEditButton }: ItemCardProps) {
  ...
  return (
    <TouchableOpacity onPress={handleNavigateToProductDetails}>
      <HStack alignItems="center" bg="$white" p={16} rounded={"$md"}>
        <Image source={ItemCardImage} width={110} height={110} alt="ItemCardImage" rounded={"$md"} />
