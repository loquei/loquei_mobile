  ...
  return (
    <VStack flex={1} px={16} py={40}>
      <Center flex={1}>
        ...
        <Text fontFamily="$heading" fontSize="$2xl" fontWeight="$bold" color="$textDark800" mt={24}>Bem vindo ao Loquei</Text>
        <Text fontFamily="$body" fontSize="$md" fontWeight="$normal" color="$textDark800" mt={12}>A maneira mais simples e rápida de alugar qualquer coisa. Entre com sua conta e descubra um mundo de facilidades.</Text>
      </Center>
