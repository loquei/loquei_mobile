...
import { Box, Divider, HStack, Heading, Image, Pressable, Text, VStack, View } from "@gluestack-ui/themed";
  ...
  return (
    <VStack>
      ...
      <VStack justifyContent="center" alignItems="center" px={16} mt={16}>
        <Image source={{ uri: userPhoto }} width={96} height={96} rounded={"$full"} borderWidth={1} borderColor="$secondary200" alt="" />
